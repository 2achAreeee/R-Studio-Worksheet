---
title: "Lab 7: Building a Graphic"
author: "Zeyan Huang"
...
```{r,eval=T}
p3<-p2+geom_smooth(aes(x=year,y=demVote,color=as.factor(south)))
p3
```
...
```{r,eval=T}
FINALPLOT2<-p1 + xlab("%Democratic") + ylab("Density") + ggtitle("Distribution of Democracy Vote from 1932")+ guides(fill=guide_legend(title="South"))+ scale_fill_manual(values=c("blue","red"))
...
FINALPLOT3<- ggplot(data=PE[PE$year==2016,]) +
      ...
      ggtitle("Distribution of Democracy Vote from 2016")+    guides(fill=guide_legend(title="South"))+ scale_fill_manual(values=c("blue","red"))
FINALPLOT3
```
